...
import Label from "../../Label"; // plasmic-import: N5lnpO35gEt_/component
...
import SliderThumb from "../../SliderThumb"; // plasmic-import: NDerCluv4RlC/component
import Description from "../../Description"; // plasmic-import: l8TBAjeVM7qT/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: q34T9TYujxy-/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ytOrs)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__oYwrB)}>
        <div
